...
class ghetto_logger:
    ...
    def __init__(self, title, print = True, directory=None):
        ...
        if os.name == 'nt':
            if directory is None:
                # Get the path of the script that imports and calls this class
                current_file_path = inspect.getfile(inspect.currentframe().f_back)
